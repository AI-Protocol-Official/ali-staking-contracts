 ...
 */
// Inheritance
contract StakingImpl is Staking, UUPSUpgradeable, OwnableUpgradeable, PausableUpgradeable {
	...
	/**
	 * @dev initialize the implementation contract. so that postConstrct is not executable.
	 */
	...
	function pause() public onlyOwner {
		// delegate to PausableUpgradeable
		_pause();
	}
